...
Display, order year, quarter, order count, 
avg freight cost only for those orders where freight
cost > 100
*/
select 
...
Display, ship region, no of orders in each region, 
min and max freight cost
